...
log4j.main = {
	...
	info 'grails.plugin.springsecurity','com.wits','org.springframework.security','org.jasig.cas'
...
// http://grails-plugins.github.io/grails-spring-security-cas/v2/guide/configuration.html
...
/*grails.plugin.springsecurity.cas.serviceUrl = 'http://cdm-app.dev-acqit.helix.gsa.gov:52001/max/j_spring_cas_security_check'
 grails.plugin.springsecurity.cas.serverUrlPrefix = 'https://login.devl.max.gov/cas'
 */

grails.plugin.springsecurity.cas.serviceUrl = 'http://localhost:8080/gmax/j_spring_cas_security_check'
grails.plugin.springsecurity.cas.serverUrlPrefix = 'https://login.devl.max.gov/cas'
